...
app_name = 'ajax'
urlpatterns = [
    path('music/<int:pk>/like/', VotesView.as_view(model=MusicClip, vote_type=LikeDislike.LIKE), name='like'),
    path('music/<int:pk>/dislike/', VotesView.as_view(model=MusicClip, vote_type=LikeDislike.DISLIKE), name='dislike'),
